(function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
        ...
        function handleCache(options, template) {
            var fn, path = options.filename, hasTemplate = template !== undefined;
            if (options.cache) {
                if (!path) {
        ...
        Template.prototype = {
            createRegex: function () {
                ...
                var src, fn, opts = this.opts, escape = opts.escapeFunction;
                ...
                if (matches && matches.length) {
                    matches.forEach(function (line, index) {
                        var closing, include, includeOpts, includeSrc;
                        ...
                        if (this.mode) {
                            ...
                            switch (this.mode) {
                                case Template.modes.EVAL:
                                    ...
                                    break;
                                case Template.modes.ESCAPED:
                                    this.source += "    ; __output.push(escape(" + line.replace(_TRAILING_SEMCOL, "").trim() + "))" + "\n";
                                    break;
                                case Template.modes.RAW:
                                    this.source += "    ; __output.push(" + line.replace(_TRAILING_SEMCOL, "").trim() + ")" + "\n";
                                    break;
        ...
        exports.escapeXML = function (markup) {
            return markup == undefined ? "" : String(markup).replace(_MATCH_HTML, function (m) {
